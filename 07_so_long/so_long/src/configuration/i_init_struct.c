...
/*   Updated: 2021/11/04 23:21:29 by jcarrete         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_textures(t_so_long_game *game)
{
	...
	t->img_player.img = mlx_xpm_file_to_image((game->mlx_data).mlx, \
		t->player_path[2], &t->img_player.width, &t->img_player.height);
...
static void	init_keycode_states(t_keycode_states *states)
{
